...
use ff::cli::args::{has_version_flag, has_multi_select_flag, is_file_path};
use std::fs;
...
fn test_help_flag_detection() {
    let args = vec!["ff".to_string(), "--help".to_string()];
    ...
    let args = vec!["ff".to_string(), "-h".to_string()];
...
fn test_multi_select_flag_detection() {
    ...
    let args = vec!["ff".to_string(), "item1".to_string(), "--multi-select".to_string()];
    assert!(has_multi_select_flag(&args));
...
fn test_missing_arguments() {
    ...
    assert_eq!(result.unwrap_err(), "Missing required argument: input-source or items");
}
...
fn test_direct_items_single_select() {
    let args = vec!["ff".to_string(), "item1".to_string(), "item2".to_string(), "item3".to_string()];
    let result = parse_args_from(&args);
    ...
    assert_eq!(config.direct_items.unwrap(), vec!["item1", "item2", "item3"]);
}

#[test]
fn test_direct_items_multi_select() {
    let args = vec!["ff".to_string(), "item1".to_string(), "item2".to_string(), "-m".to_string()];
    let result = parse_args_from(&args);
...
fn test_direct_items_multi_select_long() {
    let args = vec!["ff".to_string(), "item1".to_string(), "item2".to_string(), "--multi-select".to_string()];
    let result = parse_args_from(&args);
...
fn test_file_input() {
    ...
    assert_eq!(read_result.unwrap(), vec!["file_item1", "file_item2", "file_item3"]);
...
fn test_mixed_flags_and_items() {
    let args = vec!["ff".to_string(), "item1".to_string(), "-m".to_string(), "item2".to_string(), "--multi-select".to_string(), "item3".to_string()];
    let result = parse_args_from(&args);
...
fn test_help_and_version_flags_ignored() {
    let args = vec!["ff".to_string(), "--help".to_string(), "item1".to_string(), "item2".to_string()];
...
fn test_version_and_items_ignored() {
    let args = vec!["ff".to_string(), "--version".to_string(), "item1".to_string(), "item2".to_string()];
